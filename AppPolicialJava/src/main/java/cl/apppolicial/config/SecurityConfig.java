package cl.apppolicial.config;

import cl.apppolicial.seguridad.JwtAuthFilter;
...
public class SecurityConfig {
     ...
     * creación de usuarios). Costo 12: por encima del default de Spring
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/index.html", "/styles.css", "/script.js", "/favicon.ico", "/api/auth/login", "/api/auth/register", "/api/health").permitAll()
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        // pueda hacerle peticiones a esta API si el operador la visita
        // por error.
