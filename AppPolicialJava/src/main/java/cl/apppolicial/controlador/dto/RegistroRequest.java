...
public record RegistroRequest(
        @NotBlank @Size(min=3,max=50,message="El usuario debe tener entre 3 y 50 caracteres")
        @Pattern(regexp="^[a-zA-Z0-9._-]+$", message="El usuario solo puede tener letras, números, puntos, guiones y guiones bajos")
