...
/** Genera un resumen operativo local y conservador: solo usa datos presentes en la llamada. */
@Service
public class ResumenOperativoService {
    public String generar(String texto, Clasificador.ResultadoClasificacion c) {
        String tipo = tipoEmergencia(c.palabrasDestacadas());
